...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-wrap gap-1 px-2 py-2 border rounded-lg bg-background",
        className
      )}
      {...props}
    >
      {value.map((item, index) => (
        <Badge
          key={item}
          className={cn(
            "px-3 rounded-xl flex items-center gap-1",
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        "ml-2 bg-transparent outline-none placeholder:text-muted-foreground flex-1 w-0",
        className,
