...
import {
  Slot
} from "./chunk-M3GSXNC2.js";
import {
  require_jsx_runtime
} from "./chunk-PI2MBMP7.js";
import {
  require_react_dom
...
var RemoveScroll = React17.forwardRef(function(props, parentRef) {
  ...
  return React17.createElement(
    React17.Fragment,
    null,
    enabled && React17.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
function RemoveScrollSideCar(props) {
  ...
  var Style = React18.useState(styleSingleton)[0];
  ...
  return React18.createElement(
    React18.Fragment,
    null,
    inert ? React18.createElement(Style, { styles: generateStyle(id) }) : null,
...
var PopoverTrigger = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const trigger = (0, import_jsx_runtime8.jsx)(
      Primitive.button,
      {
        type: "button",
    ...
    return context.hasCustomAnchor ? trigger : (0, import_jsx_runtime8.jsx)(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime8.jsx)(PortalProvider, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime8.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime8.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContent = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime8.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime8.jsx)(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime8.jsx)(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var PopoverContentModal = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime8.jsx)(Combination_default, { as: Slot, allowPinchZoom: true, children: (0, import_jsx_runtime8.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverArrow = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope(__scopePopover);
    return (0, import_jsx_runtime8.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
